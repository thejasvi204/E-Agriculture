...
<?php 
$q="select cname,image,price,price1,qty,mtype from mtenali where mtype='fruit'";
...
<?php 
$q="select cname,image,price,price1,qty,mtype from mtenali where mtype='vegetable'";
$w=mysqli_query($conn,$q) or die(mysqli_error($conn));
$r=mysqli_num_rows($w);
if($w)
{ 
 ...
 <br>
 <?php 
$q="select cname,image,price,price1,qty,mtype from mtenali where mtype='other'";
$w=mysqli_query($conn,$q) or die(mysqli_error($conn));
$r=mysqli_num_rows($w);
if($w)
{ 
