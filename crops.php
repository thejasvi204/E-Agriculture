   ...
   <button class="dropbtne">soil
    ...
    <div class="dropdown-contente">
      ...
      <a class="drplnke" href="lateristic.php">Lateritic</a>
        ...
        <div class="displnk">
		  <iframe src="eag/ap.html" class="iframeagr" name="iframeagr"><iframe>		  
		</div>
...
<div class="footer">
  <footer class="footer">
  <ul><li><a style="color:#4dff4d;text-decoration:none;" href="aboutus.html">about us</a></li>
  <li><a style="color:#4dff4d;text-decoration:none;" href="contacts.html">contact info.</li>
  <li><a style="color:#4dff4d;text-decoration:none;" href="feedback.html">feedback / review.</li></ul>
  </div>
  </footer>
</body>
</html>
